...
def LoginView(page, myPyrebase):
    ...
    imagen = ft.Image(src=f"/images/Login.png", fit=ft.ImageFit.FILL, width=500, height=500, expand=1)
    encabezado = ft.Text("Bienvenido", style=ft.TextStyle(weight=ft.FontWeight.W_600, size=24), text_align=ft.TextAlign.CENTER, expand=1)
    ...
    text_register = ft.Text(
        ...
        spans=[
            ...
            ft.TextSpan(
                "¡Registrate!",
                style=ft.TextStyle(italic=True, color=ft.colors.BLUE),
    ...
    myPage = ft.SafeArea(
        ft.ResponsiveRow(
            [
                ft.Container(imagen, expand=1, alignment=ft.alignment.center, col=6),
                ft.Container(
                    content=ft.Column(
                        [
